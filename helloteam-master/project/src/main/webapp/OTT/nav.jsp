...
<link rel="stylesheet" href="./css/startmovie.css">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style = "height: 70px;width:100%;">
  <div class="container-fluid">
    <a class="navbar-brand" style="font-size:30px; font-weight:700;" href="index.jsp"><img src="./img/logo5.png" style="width:420px; position:absolute; top:-30px; left:-100px; transform:rotate(-45deg)"/></a>
<%if (vo != null) { %>
      ...
      <ul class="navbar-nav" style = "position:absolute; right:30px;">
        ...
        <li class="nav-link active dropdown" >
          ...
          <div style="width:100%; display:flex; flex-direction:column; justify-content:center;">
            ...
            <a class="dropdown-item" style="color:#000;" href="index.jsp">장르별 추천</a>
            <a class="dropdown-item" style="color:#000;" href="rank.jsp">랭킹</a>
         ...
         <!-- 상영예정작 드롭다운 -->
			<div class="dropdowna" style="color:transparent;" href="#">
					...
					<div id = "myDropdown" class = "dropdown-content">
						...
						<a href = "OttSelectCon.do?video_type=1&video_ott=netflix"> 넷플릭스 </a>
						<a href = "OttSelectCon.do?video_type=1&video_ott=watcha"> 왓챠 </a>
						<a href = "OttSelectCon.do?video_type=1&video_ott=wavve"> 웨이브 </a>
					</div>
      	...
      	<!--  종료예정작 드롭다운 -->
            ...
            <div class="dropdownb" style="color:transparent;" href="#">
					...
					<div id = "myDropdown" class = "dropdown-content b">
						...
						<a href = "OttSelectCon.do?video_type=2&video_ott=netflix"> 넷플릭스 </a>
						<a href = "OttSelectCon.do?video_type=2&video_ott=watcha"> 왓챠 </a>
						<a href = "OttSelectCon.do?video_type=2&video_ott=wavve"> 웨이브 </a>
				</div>
