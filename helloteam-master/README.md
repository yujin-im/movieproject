...
## 👀 서비스 소개
* 서비스명:  OTT 상영작 안내 서비스
* 서비스설명:  OTT 현재 사영작을 확인하려면 로그인을 하거나 정액권을 끊어야 하는 경우가 있는데<br/>
기존의 불편함을 느낀 사용자들을 위해 본 프로젝트는 각 OTT마다 어떤 서비스들을<br/>
제공하는지 한눈에 파악할 수 있게 만든다.<br/>
또한 상영/종료 예정작을 소개해 OTT사용자들이<br/>
컨텐츠를 놓치지 않는 서비스에 목적을 두고 있다.<br/>
<br>
